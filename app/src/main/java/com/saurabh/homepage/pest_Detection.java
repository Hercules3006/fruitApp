...
//                    "ốc ma"
//            };
//            result.setText(classes[maxPos%classes.length]);
//            result.setOnClickListener(new View.OnClickListener() {
//                @Override
//                public void onClick(View v) {
//                    //to search disease on internet
//                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.com/search?q="+result.getText()+" hại cây thanh long")));
//                }
//            });
//
//            model.close();
